...
public interface OefullinfoMapper extends BaseMapper<Oefullinfo> {
	 ...
	 * @return
	 */
	Oefullinfo findOefullInfoByOseId(@Param("id") Integer id,@Param("prostatus")Integer prostatus);
	 ...
	 * @return
	 */
	Map<String,Object> findOefullInfoBrowse(@Param("id") Integer id,@Param("prostatus") Integer prostatus,@Param("casetype") String casetype);
	 ...
	 * @return
	 */
	Oefullinfo findOefullInfoByLscId(@Param("id")Integer id, @Param("prostatus") Integer prostatus);
     ...
     * @return
     */
    Oefullinfo findById(@Param("id") Integer oefullinfoId);
}