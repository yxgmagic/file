 ...
 */
(function () {
    var BSTable = function (bstableId, url, columns,se,ed,et) {
        ...
        this.se = typeof se == "undefined" || se == null ? false : se;
        this.ed = typeof ed == "undefined" || ed == null ? false : ed;
        this.et = typeof et == "undefined" || et == null ? false : et;
    };
        ...
        init: function (s) {
            ...
            this.btInstance =
                $('#' + tableId).bootstrapTable({
                    ...
                    showColumns: s.showColumns,     		//是否显示所有的列
                    showRefresh: s.showRefresh,     		//是否显示刷新按钮
                    minimumCountColumns: 2,    	//最少允许的列数
                    clickToSelect: true,    	//是否启用点击选中行
                    searchOnEnterKey: true,		//设置为 true时，按回车触发搜索方法，否则自动触发搜索方法
                    columns: this.columns,		//列数组
                    pagination: true,			//是否显示分页条
                    showExport: s.se,		//是否显示导出按钮
                    exportDataType:s.ed,	//导出当前页，导出所有
                    exportTypes:s.et, 	//导出文件类型，数组。
                    height: this.height,
                    exportOptions:{  
                        fileName: s.fn,   
                        worksheetName: s.sn,      
