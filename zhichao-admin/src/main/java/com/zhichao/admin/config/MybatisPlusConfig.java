...
import com.zhichao.service.common.constant.DSEnum;
import com.zhichao.service.core.datascope.DataScopeInterceptor;
import com.zhichao.core.datasource.DruidProperties;
import com.zhichao.core.mutidatasource.DynamicDataSource;
import com.zhichao.core.mutidatasource.config.MutiDataSourceProperties;
...
@MapperScan(basePackages = {"com.zhichao.dal.*"})
public class MybatisPlusConfig {
    ...
    public DynamicDataSource mutiDataSource() {
        ...
        hashMap.put(DSEnum.DATA_SOURCE_ADMIN, dataSourceGuns);
