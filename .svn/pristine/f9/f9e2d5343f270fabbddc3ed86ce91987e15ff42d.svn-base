...
public class ServiceConfig {
    ...
    public void init() {
        ...
        imports.add(contextConfig.getProPackage() + ".service." + contextConfig.getModuleName() + ".I" + contextConfig.getBizEnBigName() + "Service");
        ...
        this.servicePathTemplate = "\\zhichao-service\\src\\main\\java\\" + contextConfig.getProPackage().replaceAll("\\.", "\\\\") + "\\service\\" + contextConfig.getModuleName() + "\\I{}Service.java";
        this.serviceImplPathTemplate = "\\zhichao-service\\src\\main\\java\\" + contextConfig.getProPackage().replaceAll("\\.", "\\\\") + "\\service\\" + contextConfig.getModuleName() + "\\impl\\{}ServiceImpl.java";
        this.packageName = contextConfig.getProPackage() + ".service." + contextConfig.getModuleName();
    }
