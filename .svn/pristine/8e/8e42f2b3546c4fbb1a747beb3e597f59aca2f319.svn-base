...
public class GunsFlowableProperties {
    ...
    //默认多数据源的链接
    private String url = "jdbc:mysql://192.168.20.14:3306/guns?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false";
