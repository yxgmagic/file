...
public class DaoConfig {
    ...
    public void init() {
        this.daoPathTemplate = "\\zhichao-dal\\src\\main\\java\\" + contextConfig.getProPackage().replaceAll("\\.", "\\\\") + "\\dal\\" + contextConfig.getModuleName() + "\\{}Dao.java";
        this.xmlPathTemplate = "\\zhichao-dal\\src\\main\\resources\\" + contextConfig.getProPackage().replaceAll("\\.", "\\\\") + "\\dal\\" + contextConfig.getModuleName() + "\\{}Dao.xml";
        this.packageName = contextConfig.getProPackage() + ".dal." + contextConfig.getModuleName();
    }
