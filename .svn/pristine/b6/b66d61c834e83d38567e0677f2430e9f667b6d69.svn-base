                    ...
                    for ( var i = 0; i < res.length; i++ ) {
                        ...
                        switch (url) {
                            case "selfixedsite":
                                ...
                                // 设置Marker的信息
                                marker = gisFeng.setMarkerInfo(res[i].sitename, lnglat.lng, lnglat.lat, 'fixedmarker', 'fixedSite');
                            ...
                            case "selpresite":
                                gisFeng.lnglatFixed.push(lnglat);
                                marker = gisFeng.setMarkerInfo(res[i].sitename, lnglat.lng, lnglat.lat, 'premarker', 'preSite');
                                gisFeng.markerPre.push(marker);
                                marker.on('click', markInfoWindow);
                                break;
                            case "selCrop":
                                gisFeng.lnglatFixed.push(lnglat);
                                marker = gisFeng.setMarkerInfo(res[i].sitename, lnglat.lng, lnglat.lat, 'corpmarker', 'corpSite');
                                gisFeng.markerCorp.push(marker);
                                marker.on('click', markInfoWindow);
                                break;
                            case "selHsway":
                                gisFeng.lnglatFixed.push(lnglat);
                                marker = gisFeng.setMarkerInfo(res[i].sitename, lnglat.lng, lnglat.lat, 'hswaymarker', 'hsWaySite');
                                gisFeng.markerHsway.push(marker);
                                marker.on('click', markInfoWindow);
                                break;
                            case "sellawMan":
                                gisFeng.lnglatFixed.push(lnglat);
                                marker = gisFeng.setMarkerInfo(res[i].sitename, lnglat.lng, lnglat.lat, 'LawMan', 'lawManSite');
                                gisFeng.markerLawMan.push(marker);
                                marker.on('click', markInfoWindow);
                                break;
                            case "sellawCar":
                                gisFeng.lnglatFixed.push(lnglat);
                                marker = gisFeng.setMarkerInfo(res[i].sitename, lnglat.lng, lnglat.lat, 'LawCar', 'lawCarSite');
                                gisFeng.markerLawCar.push(marker);
                                marker.on('click', markInfoWindow);
                                break;
                        }
                    }
